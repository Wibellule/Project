...
--
-- Client: localhost
-- Généré le: Lun 01 Juillet 2013 à 15:07
...
--
-- Contenu de la table `postscomments`
--

INSERT INTO `postscomments` (`id`, `name`, `email`, `url`, `message`, `message_backoffice`, `online`, `created`, `post_id`) VALUES
(1, 'gyome', 'gyome34@hotmail.com', 'http://www.mignon.fr', 'test', '', 1, '2013-07-01 14:09:28', 2);
